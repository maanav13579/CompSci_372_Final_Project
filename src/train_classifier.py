...
class EarlyStopping:
    ...
    def __call__(self, score: float) -> bool:
        # First epoch, save model
        if self.best_score is None:
            self.best_score = score
            return True  
        
        #save model if improved, otherwise increment counter and stop early if necessary
...
def main():
    ...
    # Plot training curves. Below code is all generated by the AI-Assistant
